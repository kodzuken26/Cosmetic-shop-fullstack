...
const extraSlides: Slide[] = [
  {
    content: (
      <div className="main2" style={{ backgroundImage: `url(${slide1Img})` }}>
  ...
  },
  {
    content: (
      <div
        className="main"
        style={{
          backgroundImage: `url(https://i.pinimg.com/1200x/bf/cf/e0/bfcfe06b90ce663d2068464d749f5147.jpg)`,
        }}
      >
  ...
  {
    content: (
      <div className="main2" style={{ backgroundImage: `url(${slide2Img})` }}>
        <div className="main-p2">
          <h2>Аксессуары</h2>
...
const Slider: FC = () => {
  const firstSlide = (
    <div
      className="main"
      style={{
        backgroundImage: `url(https://i.pinimg.com/736x/9d/4e/ff/9d4effca1e805961c77e8a2fc6a6f8c3.jpg)`,
      }}
    >
      <div className="main-p">
