...
# from rest_framework_simplejwt.views import TokenRefreshView
# from .views import (
#     RegisterAPIView, LoginAPIView, UserLogoutAPIView, UserProfileAPIView,
#     CartAPIView, AddToCartAPIView, RemoveFromCartAPIView, UpdateCartItemAPIView,
#     FavoriteListAPIView, AddToFavoriteAPIView, RemoveFromFavoriteAPIView,
#     BlogPostViewSet, ProductViewSet, CategoryViewSet
# )
...
# router.register('products', ProductViewSet, basename='product')
# router.register('categories', CategoryViewSet, basename='category')
# router.register('blog', BlogPostViewSet, basename='blog')  # ← добавили сюда

# urlpatterns = [
#     path('', include(router.urls)),  # ← все маршруты из router, включая blog
...
#     path('favorites/', FavoriteListAPIView.as_view(), name='favorites'),
#     path('favorites/add/', AddToFavoriteAPIView.as_view(), name='add-to-favorite'),
#     path('favorites/remove/<int:product_id>/', RemoveFromFavoriteAPIView.as_view(), name='remove-from-favorite'),
# ]
